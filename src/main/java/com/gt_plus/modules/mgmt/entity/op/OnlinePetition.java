 ...
 */
package com.gt_plus.modules.mgmt.entity.op;
 ...
 * @version 2017-11-28
 */
public class OnlinePetition extends DataEntity<OnlinePetition> {
	...
	public OnlinePetition() {
		super();
	}

	public OnlinePetition(String id){
		super(id);
	}
	...
	@ExcelField(title="标题", align=2, sort=14)
	...
	@ExcelField(title="正文", align=2, sort=15)
	...
	@ExcelField(title="正文1", align=2, sort=16)
	...
	@ExcelField(title="正文2", align=2, sort=17)
