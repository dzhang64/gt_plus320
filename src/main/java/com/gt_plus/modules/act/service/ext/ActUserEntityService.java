...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.gt_plus.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.gt_plus.modules.sys.entity.User(null, userId)))){
