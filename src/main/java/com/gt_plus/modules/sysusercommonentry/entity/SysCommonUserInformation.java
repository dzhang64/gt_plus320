 ...
 */
package com.gt_plus.modules.sysusercommonentry.entity;
 ...
 * @version 2018-02-22
 */
public class SysCommonUserInformation extends ActEntity<SysCommonUserInformation> {
	...
	private Date internBeginDate;		// 试用开始日期
	private Date internEndDate;		// 试用结束日期
	private String idcardFile;		// 身份证
	private String gradeCertificate;		// 毕业证
	private String personResume;		// 人员简历

	public SysCommonUserInformation() {
		super();
	}

	public SysCommonUserInformation(String id){
		super(id);
	}

	@ExcelField(title="流程任务名称", align=2, sort=7)
	...
	@ExcelField(title="归属机构编码", align=2, sort=10)
	...
	@ExcelField(title="登陆名", align=2, sort=13)
	...
	@ExcelField(title="公司邮箱", align=2, sort=14)
	...
	@ExcelField(title="照片", align=2, sort=15)
	...
	@ExcelField(title="性别", dictType="sex", align=2, sort=16)
	...
	@ExcelField(title="工号", align=2, sort=18)
	...
	@ExcelField(title="手机号码", align=2, sort=19)
	...
	@ExcelField(title="部门", fieldType=Office.class, value="office.name", align=2, sort=20)
	...
	@ExcelField(title="区域", fieldType=Area.class, value="area.name", align=2, sort=21)
	public Area getArea() {
		return area;
	}
	...
	@ExcelField(title="工资卡号", align=2, sort=22)
	...
	@ExcelField(title="员工状态", dictType="sys_user_status", align=2, sort=23)
	...
	@ExcelField(title="员工类型", dictType="sys_user_type", align=2, sort=24)
	...
	@ExcelField(title="薪资级别", align=2, sort=25)
	...
	@ExcelField(title="等级工资", align=2, sort=26)
	...
	@ExcelField(title="个人邮箱", align=2, sort=27)
	...
	@ExcelField(title="紧急联系人", align=2, sort=28)
	...
	@ExcelField(title="紧急联系人关系", align=2, sort=29)
	...
	@ExcelField(title="紧急联系人电话", align=2, sort=30)
	...
	@ExcelField(title="通信地址", align=2, sort=31)
	...
	@ExcelField(title="入职日期", align=2, sort=32)
	...
	@ExcelField(title="工作年限", align=2, sort=33)
	...
	@ExcelField(title="学生院校", align=2, sort=34)
	...
	@ExcelField(title="学生专业", align=2, sort=35)
	...
	@ExcelField(title="学历", align=2, sort=36)
	public String getEd() {
		return ed;
	}
	...
	@ExcelField(title="学位", align=2, sort=37)
	...
	@ExcelField(title="外语等级", dictType="sys_user_language", align=2, sort=38)
	...
	@JsonFormat(pattern = "yyyy-MM-dd",timezone="GMT+8") 
	@ExcelField(title="合同开始日期", align=2, sort=39)
	...
	@JsonFormat(pattern = "yyyy-MM-dd",timezone="GMT+8") 
	@ExcelField(title="合同结束日期", align=2, sort=40)
	...
	@ExcelField(title="合同编号", align=2, sort=41)
	...
	@ExcelField(title="合同类型", dictType="sys_user_contract", align=2, sort=42)
	...
	@ExcelField(title="合同期限类型", dictType="sys_user_contract_year", align=2, sort=43)
	...
	@ExcelField(title="社保交纳地", fieldType=Area.class, value="socailsecurityCity.name", align=2, sort=44)
	...
	@JsonFormat(pattern = "yyyy-MM-dd",timezone="GMT+8") 
	@ExcelField(title="试用开始日期", align=2, sort=45)
	...
	@JsonFormat(pattern = "yyyy-MM-dd",timezone="GMT+8") 
	@ExcelField(title="试用结束日期", align=2, sort=46)
	...
	@ExcelField(title="身份证", align=2, sort=47)
	...
	@ExcelField(title="毕业证", align=2, sort=48)
	...
	@ExcelField(title="人员简历", align=2, sort=49)
