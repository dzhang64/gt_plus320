...
import com.gt_plus.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private boolean entrystatus = false;  //判断是否是新修改
	...
	private String desPassword; //对称加密密码
	private String ssoLoginFlag;//是否允许SSO账号登陆
	
	private Post post;      //主岗
	private Post partPost;  //副岗
	private Level level;    //职务
	private String useable; //状态
	private Integer sort;   //排序号
	
	private String ssoDesPassword; //SSO对称加密密码
	private String newSsoDesPassword; //新的SSO对称加密密码
	
	private List<UserSsoSubsystem> userSsoSubsystemList = Lists.newArrayList(); //用户SSO子系统集合
	...
	public User(SysInternUserInformation sysInternUserInformation) {	
		super();
		this.entrystatus = true;
		this.isNewRecord = true;
		this.id = sysInternUserInformation.getId();
		Office company =new Office("1");
		this.loginFlag = Global.YES;
		this.company = company;
		this.office = sysInternUserInformation.getOffice();
		this.loginName = sysInternUserInformation.getLoginName();
		this.newPassword = "888888";
		this.newSsoDesPassword = "888888";
		this.no = sysInternUserInformation.getNameCode();
		this.name = sysInternUserInformation.getName();
		this.email = sysInternUserInformation.getComMail();
		this.useable = "1";
	}
	
	
	public User(SysCommonUserInformation sysCommonUserInformation) {	
		super();
		this.entrystatus = true;
		this.isNewRecord = true;
		...
		this.newPassword = "888888";
		this.newSsoDesPassword = "888888";
		this.no = sysCommonUserInformation.getNameCode();
		this.name = sysCommonUserInformation.getName();
		this.email = sysCommonUserInformation.getComMail();
		this.useable = "1";
	}
	...
	public User(UserInfo userInfo) {	
		...
		this.loginFlag = Global.YES;
		this.company = company;
		this.office = userInfo.getOffice();
		this.loginName = userInfo.getLoginName();
		this.newPassword = "888888";
		this.newSsoDesPassword = "888888";
		this.no = userInfo.getNameCode();
		this.name = userInfo.getName();
		this.email = userInfo.getComMail();
		this.useable = "1";
	}
	...
	public boolean getIsEntrystatus() {
		return entrystatus;
	}
