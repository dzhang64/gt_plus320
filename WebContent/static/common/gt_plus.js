...
function infoAjax(msg){
	return top.layer.msg(msg);
}

function warningAjax(msg){//通知
   return top.layer.msg(msg, {icon:0});
}

function successAjax(msg){
...
function openDialogAjax(title,url,width,height, $table){
...
//打开对话框(添加修改)
function openDialog(title,url,width,height,target,btns,params){
	...
	if (btn.length == 2) {
		...
		top.layer.open({
		    ...
		    yes: function(index, layero){
		        ...
		        if(iframeWin.contentWindow.doSubmit(pName,param[0]) ){
		        	// top.layer.close(index);//关闭对话框。
		        	  setTimeout(function(){top.layer.close(index)}, 100);//延时0.1秒，对应360 7.1版本bug
		         }
			  ...
			  btn2: function(index, layero){
			        ...
			        if(iframeWin.contentWindow.doSubmit(pName,param[1]) ){
			        	// top.layer.close(index);//关闭对话框。
			        	  setTimeout(function(){top.layer.close(index)}, 100);//延时0.1秒，对应360 7.1版本bug
			         }
		    ...
		    yes: function(index, layero){
			  ...
			  btn2: function(index, layero){
				  ...
				  btn3: function(index, layero){
				        ...
				        if(iframeWin.contentWindow.doSubmit(pName,param[2]) ){
				        	// top.layer.close(index);//关闭对话框。
				        	  setTimeout(function(){top.layer.close(index)}, 100);//延时0.1秒，对应360 7.1版本bug
				         }
			  ...
			  btn2: function(index, layero){
				  ...
				  btn3: function(index, layero){
					  ...
					  btn4: function(index, layero){
					        ...
					        if(iframeWin.contentWindow.doSubmit(pName,param[3]) ){
					        	// top.layer.close(index);//关闭对话框。
					        	  setTimeout(function(){top.layer.close(index)}, 100);//延时0.1秒，对应360 7.1版本bug
					         }
