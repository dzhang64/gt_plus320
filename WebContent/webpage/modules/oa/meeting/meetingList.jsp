	...
	<div id="toolbar">
		<shiro:hasPermission name="oa:meeting:meeting:add">
			...
			<script>
				function add(){
					...
					jp.openDialogFlow('添加会议安排', "${ctx}/oa/meeting/meeting/form",'1000px', '100%', $('#meetingTable'), params);
				}
			</script>
		</shiro:hasPermission>
		...
		<div id="oa-btn-group" class="btn-group">
			<shiro:hasPermission name="oa:meeting:meeting:edit">
		    	<a id="Unsent" href="${ctx}/oa/meeting/meeting/list/Unsent" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-edit"></i> 待发</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:meeting:meeting:edit">
			    <a id="Sent" href="${ctx}/oa/meeting/meeting/list/Sent" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-ok"></i> 已发</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:meeting:meeting:edit">
			    <a id="Todo" href="${ctx}/oa/meeting/meeting/list/Todo" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-edit"></i> 待办</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:meeting:meeting:edit">
			    <a id="Doing" href="${ctx}/oa/meeting/meeting/list/Doing" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-edit"></i> 在办</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:meeting:meeting:edit">
			    <a id="Done" href="${ctx}/oa/meeting/meeting/list/Done" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-ok"></i> 已办</a>
		    </shiro:hasPermission>
		</div>
		<%--
