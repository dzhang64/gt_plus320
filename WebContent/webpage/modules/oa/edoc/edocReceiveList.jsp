...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="edocReceive" action="${ctx}/oa/edoc/edocReceive/list/${path==null?'Todo':path}" method="post" class="form-inline">
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="oa:edoc:edocReceive:add">
				...
				<script>
					function add(){
						...
						jp.openDialogFlow('添加收文管理', "${ctx}/oa/edoc/edocReceive/form",'1000px', '100%', $('#edocReceiveTable'), params);
					}
				</script>
			</shiro:hasPermission>
		</div>
		<div id="oa-btn-group" class="btn-group" style="float: left; margin-left: 5px;">
			<shiro:hasPermission name="oa:edoc:edocReceive:edit">
		    	<a id="Unsent" href="${ctx}/oa/edoc/edocReceive/list/Unsent" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-edit"></i> 待发</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:edoc:edocReceive:edit">
			    <a id="Sent" href="${ctx}/oa/edoc/edocReceive/list/Sent" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-ok"></i> 已发</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:edoc:edocReceive:edit">
			    <a id="Todo" href="${ctx}/oa/edoc/edocReceive/list/Todo" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-edit"></i> 待办</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:edoc:edocReceive:edit">
			    <a id="Doing" href="${ctx}/oa/edoc/edocReceive/list/Doing" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-edit"></i> 在办</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:edoc:edocReceive:edit">
			    <a id="Done" href="${ctx}/oa/edoc/edocReceive/list/Done" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-ok"></i> 已办</a>
		    </shiro:hasPermission>
		</div>
		...
		<shiro:hasPermission name="oa:edoc:edocReceive:import">
		</shiro:hasPermission>
	...
	<!-- 表格 -->
	<table id="edocReceiveTable"   data-toolbar="#toolbar" data-id-field="id"></table>
