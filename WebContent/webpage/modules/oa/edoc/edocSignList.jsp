...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="edocSign" action="${ctx}/oa/edoc/edocSign/list/${path==null?'Todo':path}" method="post" class="form-inline">
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="oa:edoc:edocSign:add">
				...
				<script>
					function add(){
						...
						jp.openDialogFlow('添加签报管理', "${ctx}/oa/edoc/edocSign/form",'1000px', '100%', $('#edocSignTable'), params);
					}
				</script>
			</shiro:hasPermission>
		</div>
		<div id="oa-btn-group" class="btn-group" style="float: left; margin-left: 5px;">
			<shiro:hasPermission name="oa:edoc:edocSign:edit">
		    	<a id="Unsent" href="${ctx}/oa/edoc/edocSign/list/Unsent" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-edit"></i> 待发</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:edoc:edocSign:edit">
			    <a id="Sent" href="${ctx}/oa/edoc/edocSign/list/Sent" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-ok"></i> 已发</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:edoc:edocSign:edit">
			    <a id="Todo" href="${ctx}/oa/edoc/edocSign/list/Todo" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-edit"></i> 待办</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:edoc:edocSign:edit">
			    <a id="Doing" href="${ctx}/oa/edoc/edocSign/list/Doing" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-edit"></i> 在办</a>
		    </shiro:hasPermission>
			<shiro:hasPermission name="oa:edoc:edocSign:edit">
			    <a id="Done" href="${ctx}/oa/edoc/edocSign/list/Done" class="btn btn-sm btn-white"><i class="glyphicon glyphicon-ok"></i> 已办</a>
		    </shiro:hasPermission>
		</div>
		...
		<shiro:hasPermission name="oa:edoc:edocSign:import">
		</shiro:hasPermission>
	...
	<!-- 表格 -->
	<table id="edocSignTable"   data-toolbar="#toolbar" data-id-field="id"></table>
