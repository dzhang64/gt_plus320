		...
		$(document).ready(function() { 
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/oa/setting/taskSettingVersion/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="taskSettingVersion" class="form-horizontal">
		<form:hidden path="id"/>
		<input type="hidden" name="dirtyUpdateDate" value="${taskSettingVersion.updateDate}" />
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
			        ...
			        <td class="width-35">
						<fieldset class="set">
						<form:input path="userTaskId" htmlEscape="false"    class="form-control "/>
						</fieldset>
					</td>
			        ...
			        <td class="width-35">
						<fieldset class="set">
						<form:input path="userTaskName" htmlEscape="false"    class="form-control "/>
						</fieldset>
					</td>
				</tr>
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">人员范围：</label></td>
			
			        <td class="width-35">
						<fieldset class="set">
						<form:input path="settingValue" htmlEscape="false"    class="form-control "/>
						</fieldset>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">节点权限：</label></td>
			        ...
			        <td class="width-35">
						<fieldset class="set">
						<form:input path="ruleArgs" htmlEscape="false"    class="form-control "/>
						</fieldset>
					</td>
				</tr>
		 	</tbody>
