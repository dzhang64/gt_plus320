		...
		$(document).ready(function() { 
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/oa/setting/sequence/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="sequence" class="form-horizontal">
		<form:hidden path="id"/>
		
		
		<input type="hidden" name="dirtyUpdateDate" value="${sequence.updateDate}" />
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
			        ...
			        <td class="width-35">
						<fieldset class="set">
						<form:input path="startValue" htmlEscape="false"    class="form-control required digits"/>
						</fieldset>
					</td>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>当前值：</label></td>
			
			        <td class="width-35">
						<fieldset class="set">
						<form:input path="currentValue" htmlEscape="false"    class="form-control required digits"/>
						</fieldset>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>当前年度：</label></td>
					...
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>按年循环：</label></td>
			
			        <td class="width-35">
						<fieldset class="set">
						<form:select path="cycleByYear" class="form-control required">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictListEdit('yes_no',sequence.id)}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
						</fieldset>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>上年度值：</label></td>
			
			        <td class="width-35">
						<fieldset class="set">
						<form:input path="lastYearValue" htmlEscape="false"    class="form-control required digits"/>
						</fieldset>
					</td>
