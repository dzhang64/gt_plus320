...
<head>
	...
	<%@ include file="arcCategoryList.js" %>
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="arcCategory" action="${ctx}/oa/arc/arcCategory/" method="post" class="form-inline">
	...
	<!-- 表格 -->
	<table id="arcCategoryTreeTable" class="table table-hover">
		<thead>
			<tr>
				<th>名称</th>
				<th>排序</th>
		...
		<tbody id="arcCategoryTreeTableList"></tbody>
	</table>
	</div>
	</div>
</div>
