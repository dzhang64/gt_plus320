...
<head>
	...
	<script type="text/javascript">
		...
		function excelexport(){
		  var param =null;
		  var url ='${ctx}/projectinfo/projectInfo/export';
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="projectInfo" action="${ctx}/projectinfo/projectInfo/" method="post" class="form-inline">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="projectinfo:projectInfo:add">
			<a id="add" class="btn btn-sm btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> 添加</a>
		</shiro:hasPermission>
		<shiro:hasPermission name="projectinfo:projectInfo:del">
		</shiro:hasPermission>
		<shiro:hasPermission name="projectinfo:projectInfo:import">
			<button id="btnImport" class="btn btn-sm btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
			<div id="importBox" class="hide">
				<form id="importForm" action="${ctx}/projectinfo/projectInfo/import" method="post" enctype="multipart/form-data"
		...
		<shiro:hasPermission name="projectinfo:projectInfo:export">
	...
	<!-- 表格 -->
	<table id="projectInfoTable"   data-toolbar="#toolbar" data-id-field="id"></table>
