...
<script src='${ctxStatic}/plugin/fullcalendar/js/jquery-1.9.1.js'></script>
<script src='${ctxStatic}/plugin/fullcalendar/js/jquery-ui.js'></script>
<link rel="stylesheet" type="text/css" href="${ctxStatic}/plugin/fullcalendar/css/main.css">
<link rel="stylesheet" type="text/css" href="${ctxStatic}/plugin/fullcalendar/css/fancybox.css">
<script src='${ctxStatic}/plugin/fullcalendar/js/jquery.fancybox-1.3.1.pack.js'></script>
<link href="${ctxStatic}/plugin/fullcalendar/css/fullcalendar2.css" rel="stylesheet">
<link href="${ctxStatic}/plugin/fullcalendar/fullcalendar.print.css" rel="stylesheet">
<script src="${ctxStatic}/plugin/fullcalendar/js/fullcalendar.js"></script>
