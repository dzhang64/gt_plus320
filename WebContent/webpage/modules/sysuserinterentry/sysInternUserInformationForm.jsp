...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() { 
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/sysuserinterentry/sysInternUserInformation/save",$('#inputForm').serialize(),function(data){
						if(data.success){
		...
		function actInit() {		    
			if (jp.checkTaskPermission("${sysInternUserInformation.procTaskPermission}")) {
		...
		function ruleArgsInit(){
				var ruleArgs = eval('('+ '${sysInternUserInformation.ruleArgsJson}' +')');
       ...
       function ruleArgsUser() {
		...
		if (jp.isNeedUserList(param.type)) {
			...
			$.ajax({
						type : 'post',
						url:'${ctx}/sysuserinterentry/sysInternUserInformation/getUserList',
						data : data,
						dataType : 'json',
...
<body class="hideScroll">
		...
		<form:form id="inputForm" modelAttribute="sysInternUserInformation" class="form-horizontal">
		<form:hidden path="id"/>
		
		<input type="hidden" id="act.taskId" name="act.taskId" value="${sysInternUserInformation.act.taskId }"/>
		<input type="hidden" id="act.taskName" name="act.taskName" value="${sysInternUserInformation.act.taskName }"/>
		<input type="hidden" id="act.taskDefKey" name="act.taskDefKey" value="${sysInternUserInformation.act.taskDefKey }"/>
		<input type="hidden" id="procInsId" name="act.procInsId" value="${sysInternUserInformation.act.procInsId }"/>
		<input type="hidden" id="act.procDefId" name="act.procDefId" value="${sysInternUserInformation.act.procDefId }"/>
		...
		<input type="hidden" name="dirtyUpdateDate" value="${sysInternUserInformation.updateDate}" />
		   ...
		   <tbody>
				...
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<input type="hidden" id="photo" name="photo" value='${sysInternUserInformation.photo}' />
						<sys:gtview input="photo" uploadPath="/sysuserinterentry/sysInternUserInformation"></sys:gtview>
					</td>
				</tr>
				<tr>
			        ...
			        <td class="width-35">
						...
						<form:select path="gender" class="form-control ">
							...
							<form:options items="${fns:getDictListEdit('sex',sysInternUserInformation.id)}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
						</fieldset>
					</td>
				...
				<tr>
			        ...
			        <td class="width-35">
						<fieldset class="set">
						<form:input path="nameCode" htmlEscape="false"    class="form-control" readonly="true" style="background-color:#F8F8F8;" />
						</fieldset>
					</td>
				...
				<tr>
			        ...
			        <td class="width-35">
						<fieldset class="set">
						<sys:treeselect id="office" name="office.id" value="${sysInternUserInformation.office.id}" labelName="office.name" labelValue="${sysInternUserInformation.office.name}"
			        ...
			        <td class="width-35">
						<fieldset class="set">
						<sys:treeselect id="area" name="area.id" value="${sysInternUserInformation.area.id}" labelName="area.name" labelValue="${sysInternUserInformation.area.name}"
				...
				<tr>
			        ...
			        <td class="width-35">
						...
						<form:select path="userStatus" class="form-control ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictListEdit('sys_user_status',sysInternUserInformation.id)}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
						</fieldset>
					</td>
				</tr>
				<tr>
			        ...
			        <td class="width-35">
						...
						<form:select path="userType" class="form-control ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictListEdit('sys_user_type',sysInternUserInformation.id)}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
						</fieldset>
					</td>
					<td class="width-15 active"><label class="pull-right">薪资级别：</label></td>
			         ...
			         <td class="width-35">
						<fieldset class="set">
						<sys:gridselectcustom url="${ctx}/salarylevel/salaryLevel/selectsalary" id="salary" name="salary.id"  value="${sysInternUserInformation.salary.id}"  title="选择薪资级别" labelName="salary.level" 
						 labelValue="${sysInternUserInformation.salary.level}" cssClass="form-control required" fieldLabels="等级|基本工资|绩效工资|补贴" fieldKeys="level|basicWage|performancePay|subsidy"  fieldTypes="0|0|0|0" filter=""  searchLabel="等级" searchKey="level" ></sys:gridselectcustom>
						</fieldset>
					</td>
				</tr>
				<tr>
				...
				<tr>
			        ...
			        <td class="width-35">
						...
						<input id="entryDate" name="entryDate" type="text" maxlength="20" class="laydate-icon form-control layer-date "
							value="<fmt:formatDate value="${sysInternUserInformation.entryDate}" pattern="yyyy-MM-dd" />"/>
						</fieldset>
					</td>
				...
				<tr>
			        ...
			        <td class="width-35">
						...
						<form:select path="foreignlanguageLevel" class="form-control ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictListEdit('sys_user_language',sysInternUserInformation.id)}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
						</fieldset>
					</td>
			        ...
			        <td class="width-35">
						...
						<input id="contractSartDate" name="contractSartDate" type="text" maxlength="20" class="laydate-icon form-control layer-date "
							value="<fmt:formatDate value="${sysInternUserInformation.contractSartDate}" pattern="yyyy-MM-dd" />"/>
						</fieldset>
					</td>
				</tr>
				<tr>
			        ...
			        <td class="width-35">
						...
						<input id="contractEndDate" name="contractEndDate" type="text" maxlength="20" class="laydate-icon form-control layer-date "
							value="<fmt:formatDate value="${sysInternUserInformation.contractEndDate}" pattern="yyyy-MM-dd" />"/>
						</fieldset>
					</td>
				...
				<tr>
			        ...
			        <td class="width-35">
						...
						<form:select path="contractType" class="form-control ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictListEdit('sys_user_contract',sysInternUserInformation.id)}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
						</fieldset>
					</td>
			        ...
			        <td class="width-35">
						...
						<form:select path="contractLimit" class="form-control ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictListEdit('sys_user_contract_year',sysInternUserInformation.id)}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
						</fieldset>
					</td>
				</tr>
				<tr>
			        ...
			        <td class="width-35">
						<fieldset class="set">
						<sys:treeselect id="socailsecurityCity" name="socailsecurityCity.id" value="${sysInternUserInformation.socailsecurityCity.id}" labelName="socailsecurityCity.name" labelValue="${sysInternUserInformation.socailsecurityCity.name}"
							title="区域" url="/sys/area/treeData" cssClass="form-control " allowClear="true" notAllowSelectParent="true"/>
						</fieldset>
					</td>
			        ...
			        <td class="width-35">
						...
						<input id="internBeginDate" name="internBeginDate" type="text" maxlength="20" class="laydate-icon form-control layer-date "
							value="<fmt:formatDate value="${sysInternUserInformation.internBeginDate}" pattern="yyyy-MM-dd" />"/>
						</fieldset>
					</td>
				</tr>
				<tr>
			        ...
			        <td class="width-35">
						...
						<input id="internEndDate" name="internEndDate" type="text" maxlength="20" class="laydate-icon form-control layer-date "
							value="<fmt:formatDate value="${sysInternUserInformation.internEndDate}" pattern="yyyy-MM-dd" />"/>
						</fieldset>
					</td>
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<input type="hidden" id="idcardFile" name="idcardFile" value='${sysInternUserInformation.idcardFile}' />
						<sys:gtfinder input="idcardFile" uploadPath="/sysuserinterentry/sysInternUserInformation"></sys:gtfinder>
					</td>
				</tr>
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<input type="hidden" id="gradeCertificate" name="gradeCertificate" value='${sysInternUserInformation.gradeCertificate}' />
						<sys:gtfinder input="gradeCertificate" uploadPath="/sysuserinterentry/sysInternUserInformation"></sys:gtfinder>
					</td>
				</tr>
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<input type="hidden" id="personResume" name="personResume" value='${sysInternUserInformation.personResume}' />
						<sys:gtfinder input="personResume" uploadPath="/sysuserinterentry/sysInternUserInformation"></sys:gtfinder>
					</td>
				</tr>
				...
				<c:if test="${not empty sysInternUserInformation.id}">
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<a class="btn btn-white btn-sm " href="javascript:openDialog('查看流程历史','${ctx}/act/task/trace/photo/${sysInternUserInformation.act.procDefId}/${sysInternUserInformation.procInsId}','1000px', '600px')">流程图</a>
						<div style="margin-bottom:5px;"></div>
						<act:histoicFlowCustom procInsId="${sysInternUserInformation.act.procInsId}" />
					</td>
				</tr>
				</c:if>
		 	</tbody>
