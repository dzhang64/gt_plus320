...
<head>
	...
	<%@ include file="projectBgColumnList.js" %>
	<script type="text/javascript">
		...
		function excelexport(){
		  var param =null;
		  var url ='${ctx}/projectbg/bgcolumn/projectBgColumn/export';
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="projectBgColumn" action="${ctx}/projectbg/bgcolumn/projectBgColumn/" method="post" class="form-inline">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="projectbg:bgcolumn:projectBgColumn:add">
		...
		<shiro:hasPermission name="projectbg:bgcolumn:projectBgColumn:import">
			<button id="btnImport" class="btn btn-sm btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
			<div id="importBox" class="hide">
				<form id="importForm" action="${ctx}/projectbg/bgcolumn/projectBgColumn/import" method="post" enctype="multipart/form-data"
		...
		<shiro:hasPermission name="projectbg:bgcolumn:projectBgColumn:export">
	...
	<!-- 表格 -->
	<table id="projectBgColumnTable"   data-toolbar="#toolbar" data-id-field="id"></table>
