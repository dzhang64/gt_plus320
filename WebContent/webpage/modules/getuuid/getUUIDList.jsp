...
<html>
<head>
	<title>生成UUID管理</title>
	<meta name="decorator" content="default"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@ include file="getUUIDList.js" %>
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="getUUID" action="${ctx}/getuuid/getUUID/" method="post" class="form-inline">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="getuuid:getUUID:add">
		...
		<shiro:hasPermission name="getuuid:getUUID:del">
		</shiro:hasPermission>
		<shiro:hasPermission name="getuuid:getUUID:import">
		</shiro:hasPermission>
		
	</div>

	<!-- 表格 -->
	<table id="getUUIDTable"   data-toolbar="#toolbar" data-id-field="id"></table>
