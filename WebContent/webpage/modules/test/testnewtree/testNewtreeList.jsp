...
<head>
	...
	<%@ include file="testNewtreeList.js" %>
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="testNewtree" action="${ctx}/test/testnewtree/testNewtree/" method="post" class="form-inline">
	...
	<!-- 表格 -->
	<table id="testNewtreeTreeTable" class="table table-hover">
		<thead>
			<tr>
				<th>名称</th>
				<th>排序</th>
		...
		<tbody id="testNewtreeTreeTableList"></tbody>
	</table>
	</div>
	</div>
</div>
