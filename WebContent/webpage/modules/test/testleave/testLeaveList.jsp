...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="testLeave" action="${ctx}/test/testleave/testLeave/" method="post" class="form-inline">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<table:sortColumn id="orderBy" name="orderBy" value="${page.orderBy}" callback="sortOrRefresh();"/><!-- 支持排序 -->
			<div class="form-group">
			<span>所属部门：</span>
				<form:input path="department" htmlEscape="false" maxlength="64"  class=" form-control input-sm"/>
			</div>
			<div class="form-group">
			<span>所属区域：</span>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="test:testleave:testLeave:add">
		...
		<shiro:hasPermission name="test:testleave:testLeave:import">
		</shiro:hasPermission>
		
	</div>

	<!-- 表格 -->
	<table id="testLeaveTable"   data-toolbar="#toolbar" data-id-field="id"></table>
