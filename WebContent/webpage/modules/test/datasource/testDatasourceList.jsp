...
<html>
<head>
	<title>测试多数据源管理</title>
	<meta name="decorator" content="default"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@ include file="testDatasourceList.js" %>
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="testDatasource" action="${ctx}/test/datasource/testDatasource/" method="post" class="form-inline">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="test:datasource:testDatasource:add">
		...
		<shiro:hasPermission name="test:datasource:testDatasource:import">
		</shiro:hasPermission>
	</div>

	<!-- 表格 -->
	<table id="testDatasourceTable"   data-toolbar="#toolbar" data-id-field="id"></table>
