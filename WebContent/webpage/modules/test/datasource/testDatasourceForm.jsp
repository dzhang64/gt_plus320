		...
		$(document).ready(function() { 
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/test/datasource/testDatasource/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="testDatasource" class="form-horizontal">
		<form:hidden path="id"/>
		<input type="hidden" name="dirtyUpdateDate" value="${testDatasource.updateDate}" />
		   ...
		   <tbody>
				...
				<tr>
					...
					<td class="width-35" colspan="3">
						...
						<sys:ckfinder input="files" type="files" uploadPath="/test/datasource/testDatasource" selectMultiple="true"/>
						</fieldset>
					</td>
				</tr>
		 	</tbody>
