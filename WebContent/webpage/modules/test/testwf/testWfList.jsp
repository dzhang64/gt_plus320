...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="testWf" action="${ctx}/test/testwf/testWf/" method="post" class="form-inline">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="test:testwf:testWf:add">
		...
		<shiro:hasPermission name="test:testwf:testWf:import">
		</shiro:hasPermission>
	</div>

	<!-- 表格 -->
	<table id="testWfTable"   data-toolbar="#toolbar" data-id-field="id"></table>
