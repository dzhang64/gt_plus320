...
<body class="hideScroll">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
			        ...
			        <td class="width-35">
						<fieldset class="set" disabled="disabled">
		...
		<div class="layui-layer-btn" style="text-align: center;">
			...
			<a class="layui-layer-btn0" onclick="$('#flag').val('yes'), $('#inputForm').submit();">同意</a>
			<a class="layui-layer-btn0" onclick="$('#flag').val('no'), $('#inputForm').submit();">退回</a>
