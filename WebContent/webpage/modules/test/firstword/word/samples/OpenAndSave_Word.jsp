...
<body onUnload="WebOfficeObj.WebClose()">
	<form name="webform" method="post">  <!--保存iWebOffice后提交表单信息-->
		<p>
			...
			<!-- 保存为pdf -->
			<input  type=button value="保存为pdf到服务器" onclick="WebSavePDF()">
			<input  type=button value="保存为pdf到本地" onclick="SaveAsPDF()">
			<br><br>
			...
			<!-- 用doc文件，模板套红 -->
    		<input type=button value="模板套红" onclick="WebUseTemplate('模板一.doc')">
			<br><br>
