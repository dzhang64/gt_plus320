...
<head>
    ...
    <meta name="description" content="华鹤OA">
    ...
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="J_menuItem" href="${ctx }/sys/user/modifyShortcut">快捷设置</a>
                                </li> 
                                 <li class="divider"></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/oa/home/oaIndex" frameborder="0" data-id="${ctx}/home" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-left"><a href="#"></a>GTOA &copy; 版权信息</div>
            </div>
        </div>
        <!--右侧部分结束-->
        <!--待办通知菜单，用于在待办通知列表中，直接打开列表页-->
        <div style="display:none">
       		<a id="currentTaskMenu" class="J_menuItem" href="#"></a>
       		<a id="taskMenu" href="#" onclick="$('#currentTaskMenu').trigger('click');"></a>
       	</div>
    </div>
</body>
...
<!-- 即时聊天插件  开始-->
<link href="${ctxStatic}/plugin/layer-v3.0.3/layim/layui/css/layui.css" type="text/css" rel="stylesheet"/>
<script type="text/javascript">
...
<!--webscoket接口  -->
<%-- <script src="${ctxStatic}/plugin/layer-v3.0.3/layim/layui/layui.js"></script> --%>

<%-- <script src="${ctxStatic}/plugin/layer-v3.0.3/layim/layim.js"></script> --%>
<!-- 即时聊天插件 结束 -->
<style>
/*签名样式*/
.layim-sign-box{
