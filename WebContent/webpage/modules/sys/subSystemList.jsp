...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="subSystem" action="${ctx}/sys/subSystem/" method="post" class="form-inline">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="sys:subSystem:add">
		...
		<shiro:hasPermission name="sys:subSystem:import">
		</shiro:hasPermission>
	</div>

	<!-- 表格 -->
	<table id="subSystemTable"   data-toolbar="#toolbar" data-id-field="id"></table>
