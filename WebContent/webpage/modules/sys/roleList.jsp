...
<body class="gray-bg">
	...
	<form:form id="searchForm" modelAttribute="role" action="${ctx}/sys/role/" method="post" class="form-inline">
		...
		<div class="form-group">
			<span>归属子系统：</span>
			<form:select path="subSystem.code"  class="form-control ">
				<form:option value="" label=""/>
				<form:options items="${subSystemList}" itemValue="code" itemLabel="name" htmlEscape="false"/>
			</form:select>
		</div>
		<div class="form-group">
			<span>角色名称：</span>
	...
	<div id="toolbar">
		...
		<shiro:hasPermission name="sys:role:import">
		</shiro:hasPermission>
	</div>

	<!-- 表格 -->
	<table id="roleTable"   data-toolbar="#toolbar" data-id-field="id"></table>
