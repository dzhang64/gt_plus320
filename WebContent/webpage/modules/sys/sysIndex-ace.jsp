...
<head>
    ...
    <title>Gt_Plus快速开发框架</title>

	<%@ include file="/webpage/include/acehead.jsp"%>
	<script src="${ctxStatic}/common/inspinia-ace.js?v=3.2.0"></script>
	<script src="${ctxStatic}/common/contabs.js"></script> 
 	<meta name="keywords" content="Gt_Plus快速开发平台">
    <meta name="description" content="Gt_Plus，采用spring mvc+mybatis+shiro+bootstrap，集成代码生成器的快速开发平台">
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">GTOA</span>
							 &copy; 版权信息
						</span>
