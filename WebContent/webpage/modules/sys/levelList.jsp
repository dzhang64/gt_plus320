...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="level" action="${ctx}/sys/level/" method="post" class="form-inline">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="sys:level:add">
		...
		<shiro:hasPermission name="sys:level:import">
		</shiro:hasPermission>
	</div>

	<!-- 表格 -->
	<table id="levelTable"   data-toolbar="#toolbar" data-id-field="id"></table>
