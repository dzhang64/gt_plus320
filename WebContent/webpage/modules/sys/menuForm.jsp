	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      ...
		      <tr>
		         <td  class="width-15 active"><label class="pull-right">归属子系统:</label></td>
		         <td class="width-35" colspan="3"><form:checkboxes path="subSystemList" items="${subSystemListAll}" itemLabel="name" itemValue="code" htmlEscape="false" class="i-checks" />
