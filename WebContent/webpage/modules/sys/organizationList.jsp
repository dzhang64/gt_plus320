...
<head>
	...
	<%@ include file="organizationList.js" %>
...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="organization" action="${ctx}/sys/organization/" method="post" class="form-inline">
		...
		<table:sortColumn id="orderBy" name="orderBy" value="${page.orderBy}" callback="sortOrRefresh();"/><!-- 支持排序 -->
			...
			<span>组织名称：</span>
				<form:input path="orgName" htmlEscape="false" maxlength="50"  class=" form-control input-sm"/>
			</div>
			<div class="form-group">
			<span>组织负责人：</span>
	...
	<div id="toolbar">
		...
		<shiro:hasPermission name="sys:organization:import">
		</shiro:hasPermission>
		
	</div>

	<!-- 表格 -->
	<table id="organizationTable"   data-toolbar="#toolbar" data-id-field="id"></table>
