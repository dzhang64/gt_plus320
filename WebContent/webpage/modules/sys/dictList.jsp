...
<body class="gray-bg">
	...
	<form:form id="searchForm" modelAttribute="dict" action="${ctx}/sys/dict/" method="post" class="form-inline">
		...
		<div class="form-group">
			<span>类型：</span>
			<form:select id="types" path="types" class="form-control m-b"><form:option value="" label=""/><form:options items="${typeList}" htmlEscape="false"/></form:select>
		</div>
		<div class="form-group">
			<span>描述：</span>
			<form:input path="description" class="form-control m-b" />
		</div>
	...
	<div id="toolbar">
		...
		<shiro:hasPermission name="sys:dict:import">
	...
	<!-- 表格 -->
	<table id="dictTable"   data-toolbar="#toolbar" data-id-field="id"></table>
