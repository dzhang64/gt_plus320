		...
		$(document).ready(function() { 
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/chart/line/chartHumitureLine/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="chartHumitureLine" class="form-horizontal">
		<form:hidden path="id"/>
		<input type="hidden" name="dirtyUpdateDate" value="${chartHumitureLine.updateDate}" />
