<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.gt_plus.org/"/>
...
<!-- 引入依赖的第三方插件 -->
<script src="${ctxStatic}/plugin/slimscroll/jquery.slimscroll.min.js"></script>
...
<script src="${ctxStatic}/plugin/jquery-jbox/2.3/jquery.jBox-2.3.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/plugin/My97DatePicker/WdatePicker.js" type="text/javascript"></script>
<script src="${ctxStatic}/plugin/pace/pace.min.js"></script>
<script src="${ctxStatic}/plugin/metisMenu/jquery.metisMenu.js"></script>
<link href="${ctxStatic}/plugin/iCheck/custom.css" rel="stylesheet" />
<script src="${ctxStatic}/plugin/iCheck/icheck.min.js"></script>
<script src="${ctxStatic}/plugin/iCheck/icheck-init.js"></script>
<link href="${ctxStatic}/plugin/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
<script src="${ctxStatic}/plugin/dataTables/jquery.dataTables.js"></script>
<script src="${ctxStatic}/plugin/dataTables/dataTables.bootstrap.js"></script>
...
<script src="${ctxStatic}/plugin/layer-v3.0.3/layer/laytpl/laytpl.js"></script>
